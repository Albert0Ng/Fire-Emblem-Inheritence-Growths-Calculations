...
public class Growths{
    ...
    public static void Percy(){//Arthur's child
        ...
        do{
            System.out.println("Enter Percy's Mother here: \nOr enter stop to choose another child: ");
            Mother = s.nextLine();
            Mother = Mother.toUpperCase();
            System.out.println(Mother);
            Mother = Mother.trim(); 
    ...
    public static void Soleil(){//Laslow's child
        ...
        do{
            System.out.println("Enter Soleil's Mother here: \nOr enter stop to choose another child: ");
            Mother = s.nextLine();
            Mother = Mother.toUpperCase();
            System.out.println(Mother);
            Mother = Mother.trim(); 
    ...
    public static void Velouria(){//Keaton's child
        loop = 1;
        HP = 50; Atk = 50; Mag = 0; Skl = 40;
        Spd = 40; Lck = 35; Def = 45; Res = 30;
        do{
            System.out.println("Enter Velouria's Mother here: \nOr enter stop to choose another child: ");
            Mother = s.nextLine();
            Mother = Mother.toUpperCase();
            System.out.println(Mother);
            Mother = Mother.trim(); 
    ...
    public static void Ignatius(){//Benny's child
        ...
        do{
            System.out.println("Enter Ignatius's Mother here: \nOr enter stop to choose another child: ");
            Mother = s.nextLine();
            Mother = Mother.toUpperCase();
            System.out.println(Mother);
            Mother = Mother.trim(); 
    ...
    public static void rinkahGrowths(){
                System.out.println("\nGrowths inherited from Rinkah");
                System.out.println((HP+InheritGrowths.Rinkah.HP)/2);
                System.out.println((Atk+InheritGrowths.Rinkah.Atk)/2);
                System.out.println((Mag+InheritGrowths.Rinkah.Mag)/2);
                System.out.println((Skl+InheritGrowths.Rinkah.Skl)/2);
                System.out.println((Spd+InheritGrowths.Rinkah.Spd)/2);
                System.out.println((Lck+InheritGrowths.Rinkah.Lck)/2);
                System.out.println((Def+InheritGrowths.Rinkah.Def)/2);
                System.out.println((Res+InheritGrowths.Rinkah.Res)/2);
    }
}
